...
declare -x OVPN_CN=vpn.sfcoding.com
...
declare -x OVPN_PUSH=()
declare -x OVPN_ROUTES=([0]="10.66.77.0/24")
declare -x OVPN_SERVER=10.66.77.0/24
declare -x OVPN_SERVER_URL=udp://vpn.sfcoding.com
